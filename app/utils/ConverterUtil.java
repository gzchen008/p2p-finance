...
public final class ConverterUtil {
     ...
     * @throws Exception
     */
    public static <E, V> E toEntity(E entity, V vo) throws Exception {
        try {
            BeanUtils.copyProperties(entity, vo);
        } catch (Exception e) {
            throw new Exception("转换" + vo.getClass().getName() + "失败", e);
        }
        return entity;
    }
     ...
     */
    public static <E, V> V fromEntity(V vo, E entity) throws Exception {
        try {
            BeanUtils.copyProperties(vo, entity);
        } catch (Exception e) {
            throw new Exception("转换" + entity.getClass().getName() + "失败", e);
        }
        return vo;
    }
     ...
     */
    public static <O> O convertMap2Object(Map<String, Object> mapObj, O object) throws Exception {
        for (String key : mapObj.keySet()) {
            try {
                BeanUtils.setProperty(object, key, mapObj.get(key));
            } catch (Exception e) {
                throw new Exception(object.getClass().getName() + " 没有对应的属性：" + key, e);
            }
        }
        return object;
    }
