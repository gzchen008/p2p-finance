 ...
 */
@Entity
public class v_bill_overdue extends Model {
    public long bid_id;
    public long user_id;
    public int year;
    public int month;
    ...
    public v_bill_overdue(){
		
	}
	
	public v_bill_overdue(long bid_id, String bill_no, String name, String bid_no, double amount,
